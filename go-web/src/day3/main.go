...
func main() {
	...
	// curl "http://localhost:9000/hello/geektutu"
	geeServer.GET("/hello/:name", func(c *gee.Context) {
		// expect /hello/geektutu
		c.String(http.StatusOK, "hello %s, you're at %s\n", c.Param("name"), c.Path)
	})

	// curl "http://localhost:9000/assets/css/geektutu.css"
	geeServer.GET("/assets/*filepath", func(c *gee.Context) {
