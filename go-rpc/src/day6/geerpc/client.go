...
/*
@Time    :   2022/11/11 16:17:57
@Author  :   victor2022
@Desc    :   创建一个支持HTTP协议调用的Client
*/
func newHTTPClient(conn net.Conn, opt *Option) (*Client, error) {
	// 向服务端指定url发送创建连接的请求
	_, _ = io.WriteString(conn, fmt.Sprintf("CONNECT %s HTTP/1.0\n\n", defaultRPCPath))

	// 需要等待http响应创建后才能使用rpc协议进行通信
...
@Author  :   victor2022
@Desc    :   以TCP连接的方式创建Client，包装了dialTimeout, 用来创建指定客户端
*/
...
/*
@Time    :   2022/11/11 16:24:21
@Author  :   victor2022
@Desc    :   以HTTP连接的方式创建Client
*/
...
/*
@Time    :   2022/11/11 16:28:29
@Author  :   victor2022
@Desc    :   融合了多种客户端创建方式调用方式
*/
